...
const testimionalContainer = document.querySelector(".testimional-container");
const testimional = document.querySelector(".testimional");
...
function updateTestimonial() {
  // create user card with testimonials [index]
  const { name, position, photo, text } = testimonials[index];
  userImage.src = photo;
  username.innerHTML = name;
  testimional.innerHTML = text;
